...
run_quast(name, contigs=[contigs_2_10k], params='--gage -R ' + reference_10k)
...
assert_metric(name, 'Assembly size', ['5460'], 'gage_report.tsv')


run_quast(name, contigs=[contigs_1_1k], params='--gage -R ' + reference_1k)
check_report_files(name, ['gage_report.txt',
                          'gage_report.tsv',
                          'gage_report.tex',
                          'gage_transposed_report.tex',
...
run_quast(name, contigs=[contigs_1_1k], params='--gage -R ' + reference_1k + ' --threads 2')
check_report_files(name, ['gage_report.txt',
                          'gage_report.tsv',
                          'gage_report.tex',
                          'gage_transposed_report.tex',
