...
assert_metric(name, '# misassemblies', ['6', '12', '1', '2'])
assert_metric(name, '# local misassemblies', ['1', '40', '8', '0'])
assert_metric(name, 'Genome fraction (%)', ['88.265', '84.846', '94.882', '73.761'])