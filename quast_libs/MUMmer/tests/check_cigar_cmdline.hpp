...
#ifndef __CHECK_CIGAR_CMDLINE_HPP__
#define __CHECK_CIGAR_CMDLINE_HPP__
...
public:
  ...
  check_cigar_cmdline(int argc, char* argv[]) :
    sam_arg(""),
    ref_arg(""),
    qry_arg("")
  { parse(argc, argv); }
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
  ...
  static const char * usage() { return "Usage: check_cigar_cmdline [options] sam:PATH ref:PATH qry:PATH"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Check the cigar string of a SAM file\n\n"
...
#endif // __CHECK_CIGAR_CMDLINE_HPP__"
