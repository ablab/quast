...
assert_metric(name, '# local misassemblies', ['1', '42', '8', '1'])
assert_metric(name, '# scaffold gap loc. mis.', ['0', '11', '0', '0'])
assert_metric(name, 'Genome fraction (%)', ['88.274', '85.331', '94.888', '73.764'])