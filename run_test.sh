...
if [ ! $? -eq 0 ]; then exit 1; fi; echo; echo; $python_interpreter quast.py $contigs_1K_1 $contigs_1K_2 -o $results_dir/c1k1_c1k2_R_G_allow-ambiguity_scaffolds_threads_mincluster  -R $reference_1K -G $genes_1K  --allow-ambiguity --scaffolds --threads 5 --mincluster 50
