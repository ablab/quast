...
def usage(show_hidden=False, meta=False, short=True):
    ...
    if short:
        ...
        if meta:
            ...
            sys.stderr.write("                                      for eukaryotes (--eukaryote), or MetaGeneMark for metagenomes (--metagenemark)\n")
        ...
        if not meta:
            sys.stderr.write("    --metagenemark                    Use MetaGeneMark for gene prediction\n")
        ...
        sys.stderr.write("-a  --ambiguity-usage <none|one|all>  Use none, one, or all alignments of a contig when all of them\n")
        sys.stderr.write("                                      are almost equally good (see --ambiguity-score) [default: %s]\n" % ambiguity_usage)
