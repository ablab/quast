...
dragtable = {
  ...
  makeDraggable: function(table) {
    ...
    for (var i = 1; i < headers.length; i++) { // Vlad: changed var i = 0 → var i = 1 in order to prevent moving first column
 ...
 absolutePosition: function(elt, stopAtRelative) {
  ...
  dragEnd: function(event) {
    ...
    if (targetCol != -1 && targetCol != 0 && targetCol != dragObj.startCol) { // Vlad: added targetCol != 0 is order to prevent dragging to the forst column
