...
run_quast(name, contigs=[meta_contigs_1, meta_contigs_2, 'meta_contigs_2_with_ns.fasta'], params=''
          ...
          '--split-scaffolds --unique-mapping --fragmented --memory-efficient --no-html --no-gzip --silent --max-ref-numb 3', utility='metaquast')
...
assert_metric(name, '# unaligned contigs', ['6 + 1 part', '4 + 2 part', '4 + 2 part', '4 + 2 part'], 'combined_reference/report.tsv')