...
from local_pkg_resources.extern import six
from local_pkg_resources.extern.six.moves import urllib, map
...
__import__('local_pkg_resources.extern.packaging.version')
__import__('local_pkg_resources.extern.packaging.specifiers')
...
class _SetuptoolsVersionMixin(object):
    ...
    def __iter__(self):
        ...
        warnings.warn(
            ...
            "local_pkg_resources.parse_version. This is a legacy behavior which is "
...
def register_finder(importer_type, distribution_finder):
    ...
    that path item.  See ``local_pkg_resources.find_on_path`` for an example."""
...
def register_namespace_handler(importer_type, namespace_handler):
    ...
    ``local_pkg_resources.file_ns_handler``.
    """
    ...
    def check_version_conflict(self):
        ...
        for modname in self._get_metadata('top_level.txt'):
            if (modname not in sys.modules or modname in nsp
                ...
                continue
            if modname in ('local_pkg_resources', 'setuptools', 'site'):
                continue
...
def issue_warning(*args,**kw):
    ...
    try:
        ...
        # the local_pkg_resources module, to use for the warning
...
# randomly just because they use local_pkg_resources. We want to append the rule
...
def _initialize_master_working_set():
    ...
    of local_pkg_resources. It is intended to be invoked once at
