...
#ifndef __CHECK_LCP_CMDLINE_HPP__
#define __CHECK_LCP_CMDLINE_HPP__
...
public:
  ...
  check_LCP_cmdline(int argc, char* argv[]) :
    output_arg(""), output_given(false),
    int_flag(false),
    short_flag(false),
    sequence_arg(""),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUo:is";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    sequence_arg = string(argv[optind]);
    ++optind;
    prefix_arg = string(argv[optind]);
    ++optind;
  }
  static const char * usage() { return "Usage: check_LCP_cmdline [options] sequence:PATH prefix:PATH"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    ...
    " -o, --output=PATH                        Output LCP\n"
    " -i, --int                                LCP size is an int, not size_t (false)\n"
    " -s, --short                              No expensive computation (false)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "int_flag:" << int_flag << "\n";
    os << "short_flag:" << short_flag << "\n";
    os << "sequence_arg:" << sequence_arg << "\n";
    os << "prefix_arg:" << prefix_arg << "\n";
  }
};
#endif // __CHECK_LCP_CMDLINE_HPP__"
