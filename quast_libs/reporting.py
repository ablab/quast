...
####################################################################################
    ...
    LAP_SCORE = 'LAP score'
    REF_LAP_SCORE = 'Reference LAP score'
    ...
    order = [NAME, CONTIGS__FOR_THRESHOLDS, TOTALLENS__FOR_THRESHOLDS, CONTIGS, LARGCONTIG, TOTALLEN, REFLEN, ESTREFLEN, GC, REFGC,
             ...
             PROPERLY_PAIRED_READS_PCNT, REF_PROPERLY_PAIRED_READS_PCNT, LAP_SCORE, REF_LAP_SCORE,
    ...
    reads_order = [NAME, TOTAL_READS, LEFT_READS, RIGHT_READS,
                   ...
                   LAP_SCORE, REF_LAP_SCORE, DEPTH, COVERAGE__FOR_THRESHOLDS,
    ...
    grouped_order = [
        ...
        ('Reads mapping', [MAPPED_READS, MAPPED_READS_PCNT, PROPERLY_PAIRED_READS, PROPERLY_PAIRED_READS_PCNT,
                           SINGLETONS, SINGLETONS_PCNT, MISJOINT_READS, MISJOINT_READS_PCNT, LAP_SCORE, REF_LAP_SCORE,
