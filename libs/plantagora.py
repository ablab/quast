...
def do(reference, filenames, cyclic, rc, output_dir, lib_dir):
    ...
    metrics = ['Average %IDY', 'Misassemblies', 'Misassembled Contigs', 'Misassembled Contig Bases', 'Misassembled and Unaligned', 'Unaligned Contigs', 'Unaligned Contig Bases', 'Ambiguous Contigs']    
