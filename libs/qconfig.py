...
long_options = "output-dir= genes= operons= reference= contig-thresholds= min-contig= orf= genemark-thresholds= mauve gage not-circular disable-rc genemark extra-report help".split()
