...
assert_metric(name, '# misassemblies', ['7', '13', '1', '2'])
assert_metric(name, '# local misassemblies', ['1', '123', '9', '0'])
assert_metric(name, 'Genome fraction (%)', ['88.272', '85.063', '94.881', '73.762'])