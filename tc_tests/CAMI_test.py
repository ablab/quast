...
assert_metric_comparison(name, 'Reference length', '>=', '70000000', 'combined_reference/report.tsv')
assert_metric_comparison(name, 'gamma_proteobacterium_SCGC_AAA076-D02', '>=', '1.05', 'summary/TSV/Duplication_ratio.tsv')
assert_metric_comparison(name, 'gamma_proteobacterium_SCGC_AAA076-D02', '<=', '1.2', 'summary/TSV/Duplication_ratio.tsv')